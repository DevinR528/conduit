use crate::{PduEvent, client_server, ConduitResult, Database, Error, Result, Ruma};
...
pub fn send_transaction_message_route<'a>(
    ...
    for pdu in &body.pdus {
        ...
        let pdu = serde_json::from_value::<PduEvent>(value).expect("all ruma pdus are conduit pdus");
